    ...
    <DashboardLayout>
      <div className="container mx-auto p-6">
        <div className="flex items-center justify-between mb-8">
          ...
          <Button
            className="whitespace-nowrap p-2 rounded-xl text-white bg-linear-to-tl from-violet-800 to-purple-400 shadow-lg hover:shadow-violet-300 shadow-violet-500"
